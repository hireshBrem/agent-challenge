...
import { createConversation, formatToolInvocations } from '@/mastra/utils';
...
export async function speechToSpeechServerExample() {
...
// Commented out to allow manual invocation from components
